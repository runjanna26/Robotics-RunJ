...
clean-Core-2f-Libs:
	-$(RM) ./Core/Libs/AS5048Ainterface.cyclo ./Core/Libs/AS5048Ainterface.d ./Core/Libs/AS5048Ainterface.o ./Core/Libs/AS5048Ainterface.su ./Core/Libs/CurrentSense.cyclo ./Core/Libs/CurrentSense.d ./Core/Libs/CurrentSense.o ./Core/Libs/CurrentSense.su ./Core/Libs/can_fd.cyclo ./Core/Libs/can_fd.d ./Core/Libs/can_fd.o ./Core/Libs/can_fd.su ./Core/Libs/ekf.cyclo ./Core/Libs/ekf.d ./Core/Libs/ekf.o ./Core/Libs/ekf.su ./Core/Libs/foc_utils.cyclo ./Core/Libs/foc_utils.d ./Core/Libs/foc_utils.o ./Core/Libs/foc_utils.su ./Core/Libs/lowpass_filter.cyclo ./Core/Libs/lowpass_filter.d ./Core/Libs/lowpass_filter.o ./Core/Libs/lowpass_filter.su ./Core/Libs/motor_param.cyclo ./Core/Libs/motor_param.d ./Core/Libs/motor_param.o ./Core/Libs/motor_param.su ./Core/Libs/pid.cyclo ./Core/Libs/pid.d ./Core/Libs/pid.o ./Core/Libs/pid.su ./Core/Libs/pwm_drivers.cyclo ./Core/Libs/pwm_drivers.d ./Core/Libs/pwm_drivers.o ./Core/Libs/pwm_drivers.su ./Core/Libs/simpleFOC.cyclo ./Core/Libs/simpleFOC.d ./Core/Libs/simpleFOC.o ./Core/Libs/simpleFOC.su
